...
class ListSeriesAdapter : PagingDataAdapter<SeriesItem, ListSeriesAdapter.ViewHolder>(DIFF_CALLBACK) {
    class ViewHolder(private val binding: ListSeriesBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(data: SeriesItem){
    ...
    companion object{
        val DIFF_CALLBACK = object : DiffUtil.ItemCallback<SeriesItem>(){
